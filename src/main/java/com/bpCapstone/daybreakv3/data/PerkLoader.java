...
public class PerkLoader implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception{
        ...
        try {
            Perk[] perks = objectMapper.readValue(new File("/Users/jmisenti/Desktop/Java-Specs/daybreakv3/src/main/java/com/bpCapstone/daybreakv3/assets/SurvivorPerkArray.json"), Perk[].class);
